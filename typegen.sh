...
npx tsx --experimental-specifier-resolution=node --loader ts-node/esm node_modules/.bin/polkadot-types-from-defs --package ${filename}-typegen/interfaces --endpoint ./$filename.json --input ./src/interfaces
