...
* @returns {Uint8Array}
*/
export function new_secret(entropy_input) {
    const ret = wasm.new_secret(addHeapObject(entropy_input));
    return takeObject(ret);
}
...
* @returns {Uint8Array}
*/
export function member_from_secret(secret_input) {
    const ret = wasm.member_from_secret(addHeapObject(secret_input));
    return takeObject(ret);
}
...
* @returns {object}
*/
export function open(member_input, members_input) {
    const ret = wasm.open(addHeapObject(member_input), addHeapObject(members_input));
    return takeObject(ret);
}
