...
declare module "@polkadot/api-base/types/storage" {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    mobRule: {
      caseCount: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      cases: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array,
        ) => Observable<Option<PalletMobRuleCase>>,
        [u32]
      > &
      ...
      credits: AugmentedQuery<
        ...
        ) => Observable<PalletMobRuleMobCredit>,
        [U8aFixed]
      > &
      ...
      votes: AugmentedQuery<
        ...
        ) => Observable<Option<FrameSupportRealityJudgement>>,
        [u32, U8aFixed]
      > &
    ...
    people: {
       ...
       **/
      accountToAlias: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<FrameSupportRealityContextualAlias>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>
      /**
       ...
       **/
      aliasToAccount: AugmentedQuery<
        ApiType,
        (
          arg:
            | FrameSupportRealityContextualAlias
            | { alias?: any; context?: any }
            | string
            | Uint8Array,
        ) => Observable<Option<AccountId32>>,
        [FrameSupportRealityContextualAlias]
      > &
        QueryableStorageEntry<ApiType, [FrameSupportRealityContextualAlias]>
      /**
       * Paginated collection of static chunks used by the verifiable crypto.
       **/
      chunks: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array,
        ) => Observable<Option<Vec<ArkScale>>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
       ...
       **/
      counterForKeys: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
      ...
      keys: AugmentedQuery<
        ApiType,
        (arg: ArkScale | string | Uint8Array) => Observable<Option<u64>>,
        [ArkScale]
      > &
        QueryableStorageEntry<ApiType, [ArkScale]>
      /**
       * The current individuals we recognise: immutable ID of the individual into various
       * information about their status.
       **/
      people: AugmentedQuery<
        ApiType,
        (
          arg: u64 | AnyNumber | Uint8Array,
        ) => Observable<Option<PalletPeoplePersonRecord>>,
        [u64]
      > &
      ...
      root: AugmentedQuery<
        ApiType,
        () => Observable<Option<ITuple<[U8aFixed, u32, u32]>>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
       * The current individuals we recognise.
       **/
      rootBuilder: AugmentedQuery<
        ApiType,
        () => Observable<Option<PalletPeopleBuilder>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
    ...
    proofOfInk: {
       ...
       **/
      allocationCount: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
      ...
      candidates: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<PalletProofOfInkCandidate>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>
      /**
      ...
      configuration: AugmentedQuery<
        ApiType,
        () => Observable<PalletProofOfInkConfigRecord>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
       ...
       **/
      designFamilies: AugmentedQuery<
        ApiType,
        (
          arg: u16 | AnyNumber | Uint8Array,
        ) => Observable<Option<PalletProofOfInkFamilyKind>>,
        [u16]
      > &
      ...
      people: AugmentedQuery<
        ...
        (
          arg: u64 | AnyNumber | Uint8Array,
        ) => Observable<PalletProofOfInkPerson>,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>
      /**
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<PeopleRococoRuntimeSessionKeys>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>
      /**
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<
          Vec<ITuple<[AccountId32, PeopleRococoRuntimeSessionKeys]>>
        >,
        []
      > &
        QueryableStorageEntry<ApiType, []>
